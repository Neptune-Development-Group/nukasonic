...
public abstract class NukaSonicCustomSoundProvider implements DataProvider {
    protected final FabricDataOutput dataOutput;

    protected NukaSonicCustomSoundProvider(FabricDataOutput dataOutput) {
        this.dataOutput = dataOutput;
    }

    public abstract void generateSoundsData(NukaSonicCustomSoundBuilder nukaSonicCustomSoundBuilder);
